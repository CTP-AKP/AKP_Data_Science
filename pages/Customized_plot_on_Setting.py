...
df['not_full_audio'] = (df['full_audio']==0)*1
df['not_full_controller'] = (df['full_controller_support']==0)*1

# Header
st.header("👋")
st.title("Customized Plot on :blue[Settings]")

##### FILTER #####
# Featuer for both axis
features = ['avg', 'gain', 'peak', 'avg_peak_perc']
features += ['metacritic_score', 'positive', 'negative']
genres = ['full_audio', 'full_controller_support', 'not_full_audio', 'not_full_controller']
